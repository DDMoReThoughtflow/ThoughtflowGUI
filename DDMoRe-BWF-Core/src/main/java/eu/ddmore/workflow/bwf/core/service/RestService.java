...
public class RestService {
	...
	@Value(value="${rest.client.url}")
	private String url;
	
	@Value(value="${rest.client.port}")
	private int port;
	
	@Value(value="${rest.client.useSSL:false}")
	private Boolean useSSL;
	
	@Value(value="${rest.client.trustStore.path:#{null}}")
	private String trustStorePath;

	@Value(value="${rest.client.trustStore.password:#{null}}")
