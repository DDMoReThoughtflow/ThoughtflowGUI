...
import eu.ddmore.workflow.bwf.client.exception.EncryptionException;
...
public class StringEncrypter {
	...
	public static final String DEFAULT_ENCRYPTION_KEY   = "fourty-two?/$$47110815007$$/££FIOFMDE&&/*J()OJO";
	...
	public String encrypt(String unencryptedString) throws EncryptionException {
		...
		try {
			SecretKey key = keyFactory.generateSecret(this.keySpec);
